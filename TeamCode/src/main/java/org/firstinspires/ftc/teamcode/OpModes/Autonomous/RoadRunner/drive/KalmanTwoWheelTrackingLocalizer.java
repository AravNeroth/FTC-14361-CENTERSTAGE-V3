...
public class KalmanTwoWheelTrackingLocalizer extends TwoWheelTrackingLocalizer {
    ...
    public KalmanTwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive)
    {
        ...
        headingVelocityFilter = new KalmanFilter(5,5);
        headingFilter = new KalmanFilter(5,5);
        wheelPos1Filter = new KalmanFilter(5,5);
        wheelPos2Filter = new KalmanFilter(5,5);
        wheelPos1VelocityFilter = new KalmanFilter(5,5);
        wheelPos2VelocityFilter = new KalmanFilter(5,5);
    }
