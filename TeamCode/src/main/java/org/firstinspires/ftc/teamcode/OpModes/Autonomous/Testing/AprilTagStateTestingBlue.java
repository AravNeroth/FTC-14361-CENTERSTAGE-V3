...
@Autonomous(name = "aprilTagStateTestingBlue", group = "goobTest")
public class AprilTagStateTestingBlue extends LinearOpMode {
    ...
    double leftTapeX = 0, leftTapeY = 0, centerTapeX = 11.5, centerTapeY = 37.5, rightTapeX = 0, rightTapeY = 0;
